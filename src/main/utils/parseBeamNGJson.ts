...
export function parseBeamNGJson<T = unknown>(text: string): T {
  ...
  do {
    ...
    cleaned = cleaned.replace(
      /([}\]])(\s*)(["{\x5b0-9-]|true\b|false\b|null\b)/g,
      '$1,$2$3'
    )
    ...
    cleaned = cleaned.replace(
      /"(\s+)(["\x7b[0-9-]|true\b|false\b|null\b)/g,
